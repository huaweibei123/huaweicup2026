"""Dispatch the ten fixed P3 calendar shards with a four-cell pilot and eight-slot cap.
...
HANDOFF = ROOT / "results/a/q3-nikolastarx/calendar500-handoff-20260925"
...
def preflight():
    ...
    for n in range(1, 11):
        ...
        if value["solver_commit"] != SOURCE or value["solver_module"] != "src.q3.calendar_solve":
...
def main():
    ...
    state = {"schema": "p3-ten-shard-dispatch-v1", "source_commit": SOURCE,
             "handoff_commit": "e923cae8d38a351ee44290a967725046fd9d83ff",
             "runner_commit": SOURCE, "runner_path": "src/q3/feedback_benchmark.py",
             "controller_path": "scripts/s59ee_p3_calendar_dispatch.py", "controller_sha256": sha(__file__),
