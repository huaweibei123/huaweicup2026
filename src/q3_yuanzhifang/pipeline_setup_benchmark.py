...
OUT = "results/a/q3-yuanzhifang/pipeline-setup-20260924"
CASES = ("044",)
...
def preflight(graph_dir):
    ...
    for name in ("src/q3_yuanzhifang/pipeline_setup_benchmark.py", "src/q3_yuanzhifang/pipeline_setup_export.py",
                 "docs/a/q3-yuanzhifang/PIPELINE_SETUP_MEASUREMENT.md"):
...
class PipelineSetupPilot(Pilot):
    def __init__(self, args):
        ...
        self.info.update(schema="q3-pipeline-setup-v1", run_id="yuanzhifang-q3-pipeline-setup-20260924",
                         budget=BUDGET,
