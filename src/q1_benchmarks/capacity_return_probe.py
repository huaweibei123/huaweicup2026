"""One fixed case084/k5 mechanism experiment: one construction and one E0.
...
def run(run_id):
    ...
    for path in ('src/q1/capacity_return.py', 'src/q1_benchmarks/capacity_return_probe.py'):
    ...
    out = ROOT/'output/p1-capacity-return'/run_id
    ...
    try:
        argv=[sys.executable,'-B','src/q1/capacity_return.py',rel(graph),'--cores','5',
