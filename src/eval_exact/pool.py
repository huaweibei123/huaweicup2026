"""Bounded spawn workers for exact P1 batches; no global/default process pool.
...
from .batch import DEFAULT_CACHE_BYTES, ENGINE_VERSION, P1Evaluator
from ._official import OFFICIAL_CODE_HASH
...
def _worker(connection, graph, cache_bytes, max_cache_entries):
    try:
        evaluator = P1Evaluator(graph, cache_bytes=cache_bytes,
