"""Frozen, serial Stage A: 8 public graphs x 3 one-candidate methods.
...
SOLVER = "29a5f96459546a7bcfb2a5f769c33e570ac7dd67"
BASELINE = "4dff90ef699fd51845cf482951e8477066f5f566"
CASES = ("001", "002", "008", "010", "026", "044", "051", "094")
VARIANTS = ("fixed64-propose", "component-pack", "chain-wave")
OUTPUT = "results/a/q1-yuanzhifang/stage-a-20260924"
...
def main():
    ...
    sources.update(verify_source(ROOT, runner_commit, ["src/q1_yuanzhifang/benchmark.py"]))
    ...
    protocol = {"producer_session": SESSION, "task_url": "https://github.com/huaweibei123/huaweicup2026/issues/98",
                ...
                "budget": {"solver": 24, "E0": 24, "E1": 0, "E2": 0, "wall_seconds": 600,
                           "solver_timeout_seconds": 20, "evaluation_timeout_seconds": 40, "workers": 1, "retries": 0},
                "preparation": "Environment installed before batch using uv sync --locked (14 packages, reported install 43.79s); no training/compilation/case-specific precomputation.",
