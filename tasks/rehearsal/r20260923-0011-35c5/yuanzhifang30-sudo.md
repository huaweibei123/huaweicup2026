# 本轮合成拟合与协议验证：yuanzhifang30-sudo
...
3. **输出要求**：`src/rehearsal/r20260923-0011-35c5/yuanzhifang30-sudo.py`；`results/rehearsal/r20260923-0011-35c5/yuanzhifang30-sudo/result.json` 与 README.md；独立 PR。记录逐行预测、最大绝对残差、运行命令、环境/依赖版本、代码提交、输入哈希、seed=null。
...
Atlas task IDs：`fit-yuanzhifang30-sudo`（关联 analysis）、`protocol-yuanzhifang30-sudo`（entities=[]）。指派标签本身不产生写权限或 Agent 执行。
