"""Audit saved round5b bytes and intervals; never imports/runs solver or E0."""
...
def main():
    ...
    r4_runs=[read(p) for batch in ('round4','round5a') for p in read(f'results/a/q2-yuanzhifang/feedback-20260924/{batch}/ledger.json')['attempts']]
