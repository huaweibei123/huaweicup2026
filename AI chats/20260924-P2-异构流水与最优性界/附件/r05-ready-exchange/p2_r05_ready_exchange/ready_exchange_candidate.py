"""Project adapter for the r05 prototype. Copy together with ready_exchange.py
and calendar_avl.py into src/q2_nikolastarx/. Uses only public existing imports,
not an E2/prepared/debug API. No evaluators are called.

This adapter was syntax checked here, but not executed in the user's complete
repository or on official case 003. Its core was independently tested.
"""
